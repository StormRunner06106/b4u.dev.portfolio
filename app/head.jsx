export default function Head({ currentPage = "Home" }) {
  const pageTitle = `${
    currentPage === "Home"
      ? "William Taylor - Web Developer, Designer and Creator."
      : `${currentPage} - William Taylor`
  }`;
  const desc =
  ...
  return (
    <>
      ...
      <meta
        name="keywords"
        content="William Taylor, william taylor, freelancers, react developer, reactjs freelancer, nextjs"
      />
      <link
        rel="icon"
      ...
      <link
        ...
        href={`${process.env.NEXT_PUBLIC_BASE_URL}static/favicon/site.webmanifest`}
      />
      <link rel="canonical" href="https://williamtaylor.js.org/" />
      <meta name="title" content={pageTitle} />
      <meta name="description" content={desc} />

      <meta property="og:type" content="website" />
      <meta property="og:url" content="https://williamtaylor.js.org/" />
      <meta property="og:title" content={pageTitle} />
      <meta property="og:description" content={desc} />
      <meta
        property="og:image"
        content="https://williamtaylor.js.org/static/misc/og.png"
      />

      <meta property="twitter:card" content="summary_large_image" />
      <meta property="twitter:url" content="https://williamtaylor.js.org/" />
